...
<section class="hero py-5">
  <div class="container">
    <h2 class="fw-bold text-primary mb-4">Register to StudyNest</h2>
    ...
    <form method="POST" action="{{ route('process_register') }}" class="shadow p-4 rounded bg-white">
      @csrf
    ...
    <div class="login-link mt-2 text-end">
                        Already Register?
                        <a href="{{ route('signup') }}">Login here</a>
                    </div>
  </div>
